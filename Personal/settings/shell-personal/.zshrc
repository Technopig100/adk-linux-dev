...
alias update-kernel='/home/jacob/.Personal/Kernel/xanmod-edge-kernel/1-create-linux-xanmod-edge.sh'
alias mirror='sudo reflector --latest 5 --sort rate --save /etc/pacman.d/mirrorlist'
alias mirrorx="sudo reflector --age 6 --latest 20  --fastest 20 --threads 5 --sort rate --protocol https --save /etc/pacman.d/mirrorlist"
alias build='cd ~/.build/linux-zen/ && updpkgsums && makepkg -s'
alias git-build="sudo rm -r ~/.build/ && mkdir ~/.build/ && cd ~/.build/ && sudo pacman -Sy asp pacman-contrib --noconfirm --needed && asp update linux-zen && asp export linux-zen && cd ~/.build/linux-zen/ && sed -i 's/^pkgbase=linux-zen.*/pkgbase=linux-adk/' PKGBUILD"
